...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  async generateAvatarMV() {
    ...
    //   await this.VerifyLocator(validLinkMessage);
      ...
      await successLocator.waitFor({ state: 'visible', timeout: 900000 });
...
async DeleteHistory() {
  ...
  const deleteButton = this.page.locator(`//tr[.//h6[text()='${config.Youtube_Text_7}']][1]//button[contains(@class, 'delete-button')]`);
