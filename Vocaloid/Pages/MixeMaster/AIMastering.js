...
///////////////////////////////////////////////////////////////////////////////////////////////////////
  async AIMastering() {
    try {
      ...
      await this.uploadFile(config.Music_Audio_1);
      
      await this.page.getByRole('button', { name: 'Start Mastering' }).click();
      await this.VerifyLocator(successGenerate);
...
async DeleteHistory() {
  ...
  const deleteButton = this.page.locator(`//tr[.//h6[text()='${config.Music_Text_1}']][1]//button[contains(@class, 'delete-button')]`);
