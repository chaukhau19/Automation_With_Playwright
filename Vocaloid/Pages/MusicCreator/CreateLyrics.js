...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    async createLyrics() {
      try {
        ...
        const successLocator = this.page.locator(`//span[text()='Success']`);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    async DeleteHistory() {
      ...
      const deleteButton = this.page.locator(`//tr[.//h6[text()='${config.CreateLyrics_Name}']][1]//button[contains(@class, 'delete-button')]`);
      ...
      // await this.page.waitForSelector(`(//h6[text()='${config.CreateLyrics_Name}'])[1]`, { state: 'visible' });
