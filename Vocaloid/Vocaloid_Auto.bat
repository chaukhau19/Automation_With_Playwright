...
call npx playwright test ConvertVoice.spec.js CreateLyrics.spec.js CreateMusic.spec.js CreateMelody.spec.js AIMastering.spec.js MusicSplitter.spec.js RemoveVocal.spec.js AvatarMV.spec.js CreateMVMusic.spec.js History.spec.js --headed --reporter=html --output=./Results --workers=1

@REM call npx playwright test ConvertVoice.spec.js CreateLyrics.spec.js CreateMusic.spec.js CreateMelody.spec.js AIMastering.spec.js MusicSplitter.spec.js RemoveVocal.spec.js AvatarMV.spec.js CreateMVMusic.spec.js History.spec.js --reporter=html --output=./Results --workers=1
